  ...
  apps: [
    {
      ...
      env: {
        ...
        EX99_LIVE_MATCHES: env.EX99_LIVE_MATCHES || "1",
        EX99_SCRAPE_LIVE_ONLY: env.EX99_SCRAPE_LIVE_ONLY || "1",
        SCRAPE2_SPORT_DIR: path.join(APP, "backend/scrape2/output/sport"),
      },
      max_restarts: 20,
      autorestart: true,
    },
